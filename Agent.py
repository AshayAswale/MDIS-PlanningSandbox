...
class Agent:
  def __init__(self, starting_location, target_location) -> None:
    ...
    self.final_location=np.array(target_location)                          # History of locations that agent has been to
    self.next_location = np.array(starting_location)
    self.path=[]    # Next Location planned for the agent
